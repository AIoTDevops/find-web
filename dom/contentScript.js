...
var downloadToFile = (content, filename, contentType) => {
...
$(".yQmmFK").each(
    function() {
        names.push(returnThis($(this))().text())
    }
...
$(".go5yPW").each(
    function() {
        sales.push(returnThis($(this))().text())
    }
)
...
$(".shopee-search-item-result__item a").each(
    function() {
        links.push(returnThis($(this))().attr("href"))
    }
)
...
$("._5W0f35").each(
    function() {
        ...
        let priceRange = returnThis($(this))()[0].children;
        if (priceRange.length === 4) {
            ranges.push(
                [priceRange[1].innerHTML, priceRange[3].innerHTML]
            )
        } else {
            ranges.push(
                [priceRange[1].innerHTML]
            )
        }
...
var mapRanges = ranges.map((i, index) => {
    let mappedValue = {

    };

    mappedValue.order = index;
    mappedValue.value = i;
    mappedValue.product = names[index];
    mappedValue.sales = sales[index];
    mappedValue.links = links[index];
    return mappedValue
}).map(i => {
    return JSON.stringify(i)
})

downloadToFile(mapRanges, 'ranges.txt', 'text/plain');

// $('body').append('<div id="imgId"></div>')

// var img = $('#imgId').attr("src");
var alink = document.createElement("a");
// alink.href = img;
alink.href = "https://cf.shopee.com.my/file/60781495fbf0c81549da5e615d929793"
...
// $.get('https://cf.shopee.com.my/file/60781495fbf0c81549da5e615d929793', function(res) {
//     console.log(res)
//         // res.setEncoding('binary');
//         // downloadToFile(res, 'img.png', 'png');
//         // let str = '';
//         // res.on('data', function(chunk) {
//         //     str += chunk;
//         // })
//         // res.on('end', function() {
//         //     fs.writeFile(`./images.png`, str, 'binary', function(err) {
//         //         if (!err) {
//         //             console.log(`下载成功`);
//         //         }
//         //     })
