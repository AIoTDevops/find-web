...
$(".price strong").each(
    function() {
        prices.push(returnThis($(this))().text())
    }
...
var mapProductList = names.map((i, index) => {
    let mappedProduct = {

    };

    mappedProduct.order = index;
    mappedProduct.name = i;
    mappedProduct.price = prices[index];
    mappedProduct.link = links[index];
    return mappedProduct
}).map(i => {
    return JSON.stringify(i)
})

downloadToFile(mapProductList, 'tuhu.txt', 'text/plain');